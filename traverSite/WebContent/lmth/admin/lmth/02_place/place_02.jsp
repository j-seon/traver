	...
	<div class="place_02_contents">
		<div class="container">
			...
			<form name="">
				...
				<div class="confirm">
					<input type="button" value="취소" class="place_02_btn1" onclick="location.href='./place_01.jsp'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="button" value="확인" class="place_02_btn2" onclick="location.href='./place_01.jsp'">
				</div>
			</form>
		</div>
	</div>
