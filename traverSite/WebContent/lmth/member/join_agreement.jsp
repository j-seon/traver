...
.agreement1 { 
    ...
    position:absolute; top:100px; left:25px; margin-top:15px;
}
.agreement2 { 
    width:650px; height:100px; overflow:auto; border:solid 1px black; 
    position:absolute; top:280px; left:25px; margin-top:15px;
}
.agreement3 { 
    width:630px; height:100px; overflow:auto; border:black; 
    position:absolute; top:460px; left:25px; margin-top:15px;
}
.check1 { margin:40px 5px 5px 20px; }
.check2 { margin:160px 5px 5px 20px; }
.check3 { margin:180px 5px 5px 20px; }
.check4 { margin:200px 5px 5px 430px; }
   ...
   <div class="container-default_box">
	   	...
	   	<div class="chkbox_group">
			...
			<form name="frmChk" action="#" method="post">
				...
				'트레버')와 이를 이용하는 트레버 서비스 회원(이하 '회원') 또는 비회원과의 관계를 설명하며, 아<br />
				울러 여러분들의 트레버 서비스 이용에 도움이 될 수 있는 유익한 정보를 포함하고 있습니다.<br />
