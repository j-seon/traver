...
.container_test .pwChkBox_test .pw_ch_test {margin-top: 60px; border: 1px solid gray; border-radius: 5px; padding: 85px; text-align: center;}
   ...
   <!-- <div class="main_box"> -->
	   <div class="leftBox_test">
		...
		<div class="pwChkBox_test">
			<form name="frmPwCheck" action="pw_up.jsp" method="post" class="pw_ch_test">
