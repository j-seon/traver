...
<script>
	...
	function placeViewOptionChange(viewOption) {
		$.ajax({
			type : "POST",
...
<div class="right-side open">
	<div class="right-side_header">
		...
		<!-- 검색값 여부에  따라 btnNone 클래스 생성/삭제, btnNone 클래스가 있으면 버튼 비활성화 (=onclick 이벤트 삭제) -->
			<button name="placeCategory" id="ctgrbtn1" value="1" class="ctgr btnSelect" onclick="placeCategoryChange(this.value)">숙소</button>
			<button name="placeCategory" id="ctgrbtn2" value="2" class="ctgr" onclick="placeCategoryChange(this.value)">음식점</button>
			<button name="placeCategory" id="ctgrbtn3" value="3" class="ctgr btnNone" onclick="placeCategoryChange(this.value)">관광지</button>
		</div>
	</div>
