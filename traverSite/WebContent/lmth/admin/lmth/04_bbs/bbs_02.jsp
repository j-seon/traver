...
<link href="../../file/css/reset.css" type="text/css" rel="stylesheet">
<link href="../../file/css/style.css" type="text/css" rel="stylesheet">
...
function bbs_02_img_chn() {
    if ( state == 0 ) {
        state = 1;
        document.getElementById('bbs_02_chn').src = "../../file/img/bbs_02_down.png";
    } else {
        state = 0;
        document.getElementById('bbs_02_chn').src = "../../file/img/bbs_02_up.png";
    }
}
</script>
</head>
	...
	<div class="content">
		<div class="inner">
			<div class="sub_nav">
				<h2>게시물 관리</h2>
				<ul>
					<li><a href="../../lmth/04_bbs/bbs_01.jsp">전체 게시글</a></li>
					<li><a href="../../lmth/04_bbs/bbs_02.jsp">전체 리뷰</a></li>
				</ul>
			</div>
									...
									<tr align="center">
										...
										<td>
											<div id="btn1"  onclick="toggleBtn1()">
												...
												<img src="../../file/img/bbs_02_down.png" id="bbs_02_chn" onclick="bbs_02_img_chn()" class="bbs_02_review_img">
												</p>
											</div>
